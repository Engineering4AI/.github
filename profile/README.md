...
### [![AutoHarness](https://img.shields.io/badge/🏟️-AutoHarness-blue?style=for-the-badge)](https://huggingface.co/spaces/Engineering4AI/AutoHarness)
A self-evolving coding agent in Rust with a minimal implementation that is designed to actually run and iterate.

### [![nano-code](https://img.shields.io/badge/🏟️-nano--code-orange?style=for-the-badge)](https://huggingface.co/spaces/Engineering4AI/nano-code)
A tiny Rust coding agent that demonstrates the smallest practical architecture for automated code changes.

### [![awesome-spec-driven-development](https://img.shields.io/badge/🏟️-awesome--spec--driven--development-red?style=for-the-badge)](https://huggingface.co/spaces/Engineering4AI/awesome-spec-driven-development)
